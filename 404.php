...
<!--[if gt IE 8]><!--><html class="no-js" lang="en"><!--<![endif]-->
  ...
  <body> 
    ...
    <script>yepnope({
      load:["http://cdn.yetanotherwebdesigner.com/js/jquery.min.js","http://cdn.yetanotherwebdesigner.com/js/jquery.tools.min.js","http://cdn.yetanotherwebdesigner.com/js/yawd.js"],
      complete:function(){
