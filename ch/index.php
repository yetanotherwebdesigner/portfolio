...
<!--[if gt IE 8]><!--><html class="no-js" lang="zh"><!--<![endif]-->
  ...
  <head>
    <title>主页 | Yet Another Web Designer</title>
    <meta charset="utf-8"/> 
  ...
  <body>
    ...
    <article class="content" id="home"> 
      <p>非一般的网络设计师。尽管日常中运用的是HTML，CSS，
	及Javascript等，却绝不亚于在画板上作画的艺术家。
	欢迎雇用我为全职员工，或与我进行联系。</p> 
      <nav id="menu"> 
	<a href="tweets.php" class="menu" id="blog" title="Twitter消息">Twitter消息</a>
	<a href="portfolio.php" class="menu" id="portfolio" title="代表作品">代表作品</a>
	<a href="contact.php" class="menu" id="contact" title="联系我">联系我</a>
      </nav> 
    </article> 
