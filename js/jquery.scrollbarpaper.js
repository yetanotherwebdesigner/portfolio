// $Id: jquery.scrollbarpaper.js,v 1.1 2011/01/11 10:24:03 cvs Exp $
...
//initializing scrollbar paper
var scrollPane = $('.use-scrollbarpaper');
  if ((scrollPane.length > 0)) {
    var contentCore = $('#content-core');
    if (contentCore.length == 0) contentCore = scrollPane;
    var scrollPaneLeft = {
      height: function() {}
    };
