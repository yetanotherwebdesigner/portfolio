...
<head>
  <title>404 エラーページ | Yet Another Web Designer</title>
  <meta charset="utf-8"/> 
...
<div class="content" id="home"> 
  ...
  <h2 class="fourofour">あなたのアクセスしようとしたページはみつかりません。</h2>
  <p>あなたのご覧になっていたページからのリンクが無効になっているか、あるいはアドレス（URL）のタイプミスかもしれません。
      下記のの各カテゴリーをクリックして、ご覧になりたいページをお探しください。</p>
  <div id="menu"> 
<a href="tweets.php" class="menu" id="blog" title="ツイート">ツイート</a>
<a href="portfolio.php" class="menu" id="portfolio" title="作品集">作品集</a>
<a href="contact.php" class="menu" id="contact" title="連絡">連絡</a>
  </div> 
</div> 
